            ...
            <FieldGroup>
                ...
                <Field>
                    ...
                    <Input
                        ...
                        value={name}
                        onChange={(e) =>
                            dispatch(setSignupField({ field: "name", value: e.target.value }))
                        }
                    />
                </Field>
                <Field>
                    ...
                    <Input
                        ...
                        onChange={(e) =>
                            dispatch(
                                setSignupField({ field: "email", value: e.target.value })
                            )
                        }
                    />
                </Field>
                <Field>
                    ...
                    <FieldDescription className={cn(
                        password.length === 0 ? "text-muted-foreground" :
                            password.length < 8 ? "text-destructive" : "text-green-500"
                    )}>

...
import { Search, Globe, History, LayoutDashboard, User, Settings2, Command, X } from "lucide-react"
...
export default function DashboardLayout() {
    ...
    const { searchQuery, isSearchOpen, history } = useSelector((state) => state.dashboard)
    ...
    return (
        <TooltipProvider>
            <SidebarProvider>
                <AppSidebar />
                <SidebarInset>
                    <header className="flex h-16 shrink-0 items-center justify-between gap-2 px-6 transition-[width,height] ease-linear group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-12 border-b border-neutral-200 bg-white/80 backdrop-blur-xl sticky top-0 z-10">
                        ...
                        <div className="flex items-center gap-3">
                            <div className="flex items-center gap-3 relative mr-4">
                                <div
                                    ...
                                    className="flex items-center gap-2 px-3 py-1.5 rounded-lg border border-neutral-200 bg-neutral-50 text-sm text-neutral-500 cursor-pointer hover:border-neutral-300 transition-colors"
                                >
                                ...
                                {isSearchOpen && (
                                    <div className="fixed inset-0 z-[60] flex items-start justify-center pt-20 px-4 bg-black/20 backdrop-blur-sm" onClick={() => dispatch(setIsSearchOpen(false))}>
                                        <div
                                            className="w-full max-w-xl bg-white rounded-xl shadow-2xl border border-neutral-200 overflow-hidden animate-in fade-in zoom-in-95 duration-200"
                                                                ...
                                                                {filteredHistory.map(job => (
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <div className="flex-1 min-w-0">
                                                                            <div className="text-sm font-medium text-neutral-700 truncate">{job.url}</div>

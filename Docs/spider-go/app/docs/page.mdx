...
SpiderGo uses cookie-based auth for dashboard endpoints and bearer API keys for versioned programmatic endpoints. If you are building an integration, start with [Backend API](/docs/backend-api).
